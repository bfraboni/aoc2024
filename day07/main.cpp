...
// AoC Day 7: https://adventofcode.com/2024/day/7
...
inline size_t concatenate(size_t a, size_t b)
{
...
template<bool concat>
inline bool test(const size_t search, const std::vector<size_t>& data)
{
    bool res = false;
...
{   
    ...
    {   
        ...
        while(iss >> a) data.emplace_back(a);
